#' Revised Atlantic Hurricane Database
#'
#' @description A dataset containing information about the histories of
#' cyclones that formed over the Atlantic Ocean
#'
#' @format A dataframe with 53972 observations (1952 unique hurricanes) of
#' 23 variables
#' \describe{
